        ...
        <div className="max-w-5xl mx-auto bg-white px-6">
          <article className="overflow-hidden">
            ...
            <div className="bill-details">
              <div className="grid sm:grid-cols-4 grid-rows gap-12">
              ...
              <table className="min-w-full divide-y divide-slate-500 overflow-hidden">
                <thead>
                  <tr className="border-b border-slate-200">
                    <th
                      scope="col"
                      className="py-3.5 pl-4 text-left text-sm font-normal text-slate-700 sm:pl-0 md:pl-0 sm:table-cell hidden"
                    >
                      Görsel
                    </th>
                    <th
                      scope="col"
                      className=" py-3.5 text-left text-sm font-normal text-slate-700 sm:pl-0 md:pl-0 sm:table-cell hidden"
                    >
                      Başlık
                    </th>
                    <th
                      colSpan={4}
                      scope="col"
                      className=" py-3.5 text-left text-sm font-normal text-slate-700 sm:pl-0 md:pl-0 sm:hidden"
                    >
                      Başlık
                    </th>
                    <th
                      scope="col"
                      className="py-3.5 pl-4 text-center text-sm font-normal text-slate-700 sm:pl-0 md:pl-0 sm:table-cell hidden"
                    >
                      Fiyat
                    </th>
                    <th
                    ...
                    <th
                      scope="col"
                      className="py-3.5 pl-4 text-end text-sm font-normal text-slate-700 sm:pl-0 md:pl-0 "
                    >
                      Toplam
                    </th>
                  </tr>
